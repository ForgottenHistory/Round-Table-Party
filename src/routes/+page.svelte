...
<div class="min-h-screen bg-[var(--bg-primary)]">
	<!-- Header -->
	<div class="bg-[var(--bg-secondary)] border-b border-[var(--border-primary)]">
		<div class="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
			...
			<div class="flex items-center gap-3">
				...
				<a
					href="/settings"
					class="p-2 text-[var(--text-muted)] hover:text-[var(--accent-primary)] hover:bg-[var(--bg-tertiary)] rounded-lg transition"
					title="LLM Settings"
				>
